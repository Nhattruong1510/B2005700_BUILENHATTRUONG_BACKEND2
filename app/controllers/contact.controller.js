...
exports.findAllFavorite = async (req, res, next) => {
    try {
        ...
        return next(new ApiError(500, "An error occurred while retrieving the favorite contacts!"));
    }
};
...
exports.deleteAll = async (req, res, next) => {
    try {
        ...
        return next(new ApiError(500, "An error occurred while deleting the contacts!"));
    }
};
